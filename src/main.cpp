  ...
  while(!WindowShouldClose())
    {
      ...
      cube.draw();      
      DrawPlane({0.0f, 0.0f, 0.0f}, {25.0f, 50.0f}, DARKGREEN); 
      ...
      std::string highScoreText = "High Score: " + std::to_string(cube.highScore);
      DrawText(highScoreText.c_str(), SCREEN_WIDTH - 180, 35, 20, YELLOW);
      
      scoreText = "Score: " + std::to_string(cube.score);
      DrawText(scoreText.c_str(), SCREEN_WIDTH - 150, 10, 20, WHITE);
